...
class TestCard(unittest.TestCase):
    ...
    def test_q7(self):
        ...
        c9 = hw5_cards.Deck()
        c9_2 = c9.deal_card()
        c9.replace_card(c9_2) #remove a card from c9 deck

        #self.assertGreater(c9_up, c9_2)
    ...
    def test_q8(self):
        ...
        '''
        c10 = hw5_cards.Deck()
        c10.replace_card(c10.cards[10])

        self.assertEqual(len(c10.cards), 52)
        return len(c10.cards), 52
